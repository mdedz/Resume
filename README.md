...
> *В данном репозитории публичны только два модуля. Модуль связи SAS (Проект 4) и Клиентская часть Проекта 2. Серверная часть Проекта 2 и остальные проекты — проприетарные разработки для клиентов и закрыты по NDA, но все они в боевой эксплуатации.*
